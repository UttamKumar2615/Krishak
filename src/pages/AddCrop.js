...
class AddCrop extends React.Component {
  state = {
    ...
    farmerPhNo: null,
    cropID: "",
    btn: <input type="submit" className="customBtn" value="Upload" />,
  };
  ...
  render() {
    ...
    if (this.state.loggedInUserCategory) {
      if (this.state.loggedInUserCategory === "farmer") {
        displayContent = (
          <div>
            <h1 id="highlight" style={{ marginTop: "5%" }}>
              Add your crop details here..
            </h1>
            <br />
            <form onSubmit={this.handleSubmit}>
              <label>
                ...
                <input
                  type="text"
                  name="crop"
                  placeholder="eg: HMT Rice, Masoor Dal"
        ...
        displayContent = (
          <div id="highlight">
            ...
            <p>
              Please return to <Link to="/home">home page</Link> to continue
              your experience!
            </p>
          </div>
        );
      ...
      displayContent = (
        <div className="col-md-6" id="highlight">
          <h2>
            Dear user, if you're a farmer, please <Link to="login">login</Link>{" "}
            to continue..
          </h2>
        </div>
      );
    ...
    return (
      <div id="info" className="row">
        <div className={this.state.formStyle}>{displayContent}</div>
  ...
  handleSubmit = (e) => {
    ...
    this.setState({
      cropID:
        this.state.farmerPhNo +
        this.state.crop.replace(/ /g, "").toLowerCase() +
        currentTimestamp,
      btn: (
        <button
