      ...
      <div>
        <div id="product-details" className={this.state.pageStyle}>
          ...
          <div className="col-sm-8" style={{ padding: "10px" }}>
            ...
            <p>
              <i className="fas fa-phone-alt"></i> {this.state.phNo}
            </p>
            <p>
              <i className="fas fa-at"></i> {this.state.email}
            </p>
            <button
              className="customBtn"
          ...
          <div className={this.state.purchaseHistoryStyle}>
            ...
            <div>
              {this.state.products.map((product, pos) => {
                return product.bidEnds ? (
                  product.bidEnds <= currentTimestamp ? (
                    <div
                      id="info"
                      key={pos}
                      onClick={() => this.onVisitProduct(pos)}
                    ...
                    >
                      ...
                      <p>
                        Sold by: {product.farmerName} ({product.farmerEmail})
                      </p>
                      <p>
                        Amount Paid: &#8377;
                        {product.quantity_kg * product.price}
                      </p>
                      <div>
                        {product.review ? (
                          <p></p>
                          ...
                          <p className="alert alert-warning" role="alert">
                            Dear user, reviewing this product is pending.
                            <br />
                  ...
                  >
                    ...
                    <p>
                      Amount Paid: &#8377;{product.quantity_kg * product.price}
                    </p>
                    <div>
                      {product.review ? (
                        <p></p>
